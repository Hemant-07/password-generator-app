...
function App() {
  ...
  const createPassword = (characterList) => {
      ...
      for(let i = 0;i<passwordLength;i++){
        ...
        password = password + characterList.charrAt(characterIndex)
      }
    ...
    <div className='App'>
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="lowercase-letters"> Include Lowerercase letters</label>
          ...
          <button onClick={handleGeneratePassword} className="gererator_btn">
